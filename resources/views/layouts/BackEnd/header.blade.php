                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                     {!! Html::image('BackEnd/assets/images/users/1.jpg','user', array('class' => 'img-circle')) !!}
                                            ...
                                            <a href="#">
                                                <div class="user-img">
                                                {!! Html::image('BackEnd/assets/images/users/2.jpg','user', array('class' => 'img-circle')) !!}
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                {!! Html::image('BackEnd/assets/images/users/3.jpg','user', array('class' => 'img-circle')) !!}
                                            ...
                                            <a href="#">
                                                <div class="user-img"> 
                                                {!! Html::image('BackEnd/assets/images/users/4.jpg','user', array('class' => 'img-circle')) !!}
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container">
                                                         {!! Html::image('BackEnd/assets/images/big/img1.jpg','First slide')!!}
                                                        </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container">
                                                    {!! Html::image('BackEnd/assets/images/big/img2.jpg','First slide')!!}                                                        
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container">
                                                    {!! Html::image('BackEnd/assets/images/big/img3.jpg','First slide')!!}
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated bounceInDown"> <a class="dropdown-item" href="{{  url("/ar")."/".Request::path()}}"><i class="flag-icon flag-icon-in"></i> India</a> <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-fr"></i> French</a> <a class="dropdown-item" href="{{  url("/ar") }}"><i class="flag-icon flag-icon-cn"></i> China</a> <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-de"></i> Dutch</a> </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Profile -->
                        <!-- ============================================================== -->
