    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            @foreach($permission as $value)
             <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class'=>"js-switch" ,'data-color'=>"#009efb")) }}
                {{ $value->name }}</label>
            <br/>
            @endforeach
@else
@foreach($permission as $value)
@can($value->name)  <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class'=>"js-switch" ,'data-color'=>"#009efb")) }}
