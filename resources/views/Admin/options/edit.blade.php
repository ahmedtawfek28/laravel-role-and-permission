         ...
         <div class="row">
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>key:</strong>
		            <input type="text" name="key" value="{{ $option->key }}" class="form-control" placeholder="key">
		        </div><div class="form-group">
		            <strong>value:</strong>
		            <input type="text" name="value" value="{{ $option->value }}" class="form-control" placeholder="value">
		        </div>
		    </div>
